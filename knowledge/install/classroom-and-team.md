...
**一句話結論**：統一規定「雲端模型，不把顯示卡列入報名條件」，把所有硬體問題壓成一條線：**建議 16 GB 記憶體、30 GB 硬碟，而且不能是 Intel Mac**。真正會讓現場卡住的不是硬體，是帳號和網路。
...
- **儲存空間**：30 GB 以上
- **顯示卡**：NVIDIA **顯示記憶體 12 GB 以上**，或 Apple M 系列統一記憶體 16 GB 以上。官方寫顯示卡「不需要」，但純處理器每次回答要等 30 到 120 秒，課堂上等於停擺，所以這裡照實際可用的門檻列
