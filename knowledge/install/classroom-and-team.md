...
**一句話結論**：統一規定「雲端模型 + 不要求顯示卡」，把所有硬體問題壓成一條線：**8 GB 記憶體、20 GB 硬碟、不是 Intel Mac**。真正會讓現場卡住的不是硬體，是帳號和網路。
...
- **記憶體 (RAM)**：8 GB 以上，16 GB 更順
- **儲存空間**：20 GB 以上可用空間
- **顯示卡 (GPU)**：**不需要**
- **網路**：全程需要連線
- **不能參加的機型**：2020 年以前的 Intel Mac，官方明確不支援[^1]
...
1. **Intel Mac** — 學員規格再好都裝不起來。行前信一定要問「晶片」那一欄。
...
- **儲存空間**：30 GB 以上
- **顯示卡**：NVIDIA 顯示記憶體 8 GB 以上，或 Apple M 系列
